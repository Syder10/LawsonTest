-- Final comprehensive production management schema
-- This schema reflects all forms currently used in the web application
...
-- ============================================
-- ALCOHOL AND BLENDING DEPARTMENT
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_extraction_beginning_date ON extraction_monitoring_records(beginning_date);
...
CREATE INDEX IF NOT EXISTS idx_stocks_time ON stocks_labels_caps_records(time);
